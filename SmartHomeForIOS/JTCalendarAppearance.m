...
//hgc 2015 11 06 start
//    [self setDayDotColorForAll:[UIColor colorWithRed:43./256. green:88./256. blue:134./256. alpha:1.]];
    //----------------------original
    [self setDayDotColorForAll:[UIColor colorWithRed:253./256. green:159./256. blue:10./256. alpha:1.]];
//hgc 2015 11 06 end
...
//    self.dayCircleColorToday = [UIColor colorWithRed:0x33/256. green:0xB3/256. blue:0xEC/256. alpha:.5];
    //----------------------original
    self.dayCircleColorToday = [UIColor colorWithRed:18/256. green:141/256. blue:219/256. alpha:1];
//hgc 2015 11 06 end
