...
@interface CloudFileViewController : UIViewController<UITableViewDataSource, UITableViewDelegate,FileDialogDelegate,MWPhotoBrowserDelegate,UIGestureRecognizerDelegate>
